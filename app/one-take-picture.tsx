...
export default function TakePicture() {
  ...
  useEffect(() => {
    ...
    const checkPendingProcess = async () => {
      try {
        const pendingProcess = await AsyncStorage.getItem('pending_photo_process');
              ...
              onPress: async () => {
                try {
                  ...
                  if (response.data && response.data.data) {
                    const { ingredients, nutrition_info } = response?.data?.data;
                    ...
                    if (nutrition_info) {
                      await AsyncStorage.setItem('nutrition_info', JSON.stringify(nutrition_info));
                    }
